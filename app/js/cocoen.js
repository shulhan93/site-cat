class Cocoen {
  ...
  createElements() {
    ...
    this.element.lastElementChild.appendChild(span);
    console.log(this.element.lastElementChild)
    // Wrap first image in div
    const wrapper = document.createElement('div');
    const firstImage = this.element.querySelector('.cocoen-img:first-child');
    ...
    this.beforeImage = this.beforeElement.querySelector('.cocoen-img');
  }
